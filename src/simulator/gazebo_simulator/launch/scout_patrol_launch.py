...
def generate_launch_description():
    ...
    # 获取机器人模型的URDF文件的描述信息
    urdf_model_file = os.path.join(gazebo_simulator_dir, 'urdf', 'scout_robot', 'robot.xacro')
    ...
    default_word_file = os.path.join(gazebo_simulator_dir, 'world', 'scout_robot', 'world.world')
    # default_word_file = '/home/zx/Develop/world/Finals Prize Round World 04/final_event_04.sdf'
    ...
    # Gazebo加载机器人模型
    action_spawn_entity = Node(package='gazebo_ros', executable='spawn_entity.py', arguments=['-topic', '/robot_description', '-entity', 'scout_bot'])
    
    # 获取RViz2节点
    rviz_config_file = os.path.join(gazebo_simulator_dir, 'rviz', 'scout_robot.rviz')
